...
/**
 * Transition avec interpolation smoothstep.
 * Accélère au début, reste constant au milieu, puis ralentit à la fin.
 * Utilise la formule: t² × (3 - 2t)
...
public class SmoothStepTransition implements ITransitionStrategy {
    ...
    /**
     * Calcule l'interpolation smoothstep.
     * Crée une transition douce avec accélération et décélération progressives.
     *
