...
/**
 * Transition avec accélération au début et décélération à la fin (ease-in-out).
 * La transition démarre lentement, accélère au milieu, puis ralentit à la fin.
 * Combine ease-in pour la première moitié et ease-out pour la seconde.
...
public class EaseInOutTransition implements ITransitionStrategy {
    ...
    /**
     * Calcule l'interpolation ease-in-out.
     * Première moitié: accélération (ease-in)
     * Seconde moitié: décélération (ease-out)
     *
