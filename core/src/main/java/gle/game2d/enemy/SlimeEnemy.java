...
/**
 * Ennemi de type Slime
 */
class SlimeEnemy extends EnemyBase {
    private static final String SPRITE_PATH = "maps/Slime_Green.png";
     ...
     * Constructeur
     */
    public SlimeEnemy(float x, float y, EnemyStats stats, IEnemyBehavior behavior,
